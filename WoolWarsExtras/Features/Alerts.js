...
function setCoordValue(value, pos) {
	...
	if (value == teamColor && midCoords[parseInt(pos)][2] == enemyColor) {
		if (config.all_updates) {
			ChatLib.chat(`&d[&bExtras&d] &7One of the enemies ${enemyprefix}${enemyColor} &7blocks was broken.`)
		}
	}
	if (value == enemyColor && midCoords[parseInt(pos)][2] == teamColor) {
		if (config.all_updates) {
			ChatLib.chat(`&d[&bExtras&d] &7One of your ${teamprefix}${teamColor} &7blocks was broken.`)
		}
	}
	...
	if (value == "Air" && midCoords[parseInt(pos)][2] == "Unclaimed") {
		if (config.all_updates) {
			ChatLib.chat(`&d[&bExtras&d] &7An &aUnclaimed &7block was broken.`)
		}
	}
	if (value == enemyColor && midCoords[parseInt(pos)][2] == "Air") {
		...
		if (config.all_updates) {
			ChatLib.chat(`&d[&bExtras&d] &7One of the enemies ${enemyprefix}${enemyColor} &7blocks was placed.`)
		}
	}
	if (value == teamColor && midCoords[parseInt(pos)][2] == "Air") {
		if (config.all_updates) {
			ChatLib.chat(`&d[&bExtras&d] &7One of your ${teamprefix}${teamColor} &7blocks was placed.`)
		}
	}

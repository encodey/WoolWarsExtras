...
class config {
    ...
    getDiscord() {
        discordMsg = new TextComponent(`&d[&bExtras&d] &r&c&lClick to join the discord!`).setClick(
            "open_url",
    ...
    @SwitchProperty({
        name: "Enable Update Checker",
        description: "Checks for new updates of the module via github.",
        category: "General",
    })
    updater = false;
    ...
    @SwitchProperty({
        name: "Enable Stat Logs",
        description: "Toggles the stat logs",
        category: "Stats",
        subcategory: "Logs",
    })
    logs = false;
    ...
    @SwitchProperty({
        name: "Enable Block Placed/Broken Log",
        description: "Toggle the block stats logs at the end of a game.",
        category: "Stats",
        subcategory: "Logs",
    })
    blockLog = false;
    ...
    @SwitchProperty({
        name: "Show Game Version",
        description: "Shows game version in Discord RPC when hovering over icon",
        category: "Discord RPC"
    })
    discord_version = true;

    // prefix

    @TextProperty({
        name: 'Custom Prefix',
        description: 'Custom prefix for all mod chat messages. Use & for color codes. Reset with /ww resetprefix',
        category: 'General',
    })
    prefix = "&d[&bExtras&d]";
    ...
    @SwitchProperty({
        name: "Enable Custom Keystone Message",
        description: "Toggle keystone message",
        category: "Chat",
        subcategory: "Keystone",
    })
    keystone_toggle = false;

    @SwitchProperty({
        name: "Use Prefix In Keystone Message",
        description: "Toggle keystone message using prefix",
        category: "Chat",
        subcategory: "Keystone",
    })
    keystone_prefix = false;

    @TextProperty({
        name: 'Custom Keystone Used Message',
        description: 'Custom keystone used message. Use & for color codes. Reset with /ww resetkeystone',
        category: 'Chat',
        subcategory: "Keystone",
    })
    keystone = "&6You used your &cKEYSTONE";

    // end 

    @SwitchProperty({
        name: "Enable Custom End Message",
        description: "Makes message at the end of a game look cleaner",
        category: "Chat",
        subcategory: "End Message",
    })
    custom_endmsg = false;
    ...
    @SwitchProperty({
        name: "Enable Custom Join Game Message",
        description: "Makes message when you join a game look cleaner",
        category: "Chat",
        subcategory: "Start Message",
    })
    custom_startmsg = false;
    ...
    constructor() {
        ...
        this.addDependency("Enable Death Log", "Enable Stat Logs")
        this.addDependency("Enable Kill Log", "Enable Stat Logs")
        this.addDependency("Enable KD Log", "Enable Stat Logs")
        this.addDependency("Enable Block Placed/Broken Log", "Enable Stat Logs")
        ...
        this.addDependency("Show Game Version", "Enable Discord RPC")
        this.addDependency("Custom Keystone Used Message", "Enable Custom Keystone Message")
        this.addDependency("Use Prefix In Keystone Message", "Enable Custom Keystone Message")
    }
}
